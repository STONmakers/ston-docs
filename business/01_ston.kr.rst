...
Web Cache를 도입하여 설치 및 적용부터 운영에 이르는 과정까지, 가장 많이 조작하는 담당자는 보통 운영자(SE, System Engineer)다. 
...
64bit x86계열의 일반 상용서버라면 문제없이 작동하며, 대부분의 리눅스 버전을 지원하여 소프트웨어 제품으로서의 범용성을 극대화하였다.
