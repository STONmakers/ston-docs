...
-  ``<BalanceMode> (기본: RoundRobin)``
   ...
   -  ``RoundRobin (기본)`` 
      ...
      /           RoundRobin                                                         
      =========== ===================================================================
      부하(요청)	모든 서버가 부하를 균등하게 분배	                                
      연결비용	  높음 (해당 서버의 순서가 되면 연결된 세션을 찾고 없으면 연결시도)  
      재사용성	  낮음 (서버 분배 우선)	                                            
      세션수	    많음 (각 서버마다 동시에 진행되는 HTTP 트랜잭션의 합)              
      =========== ===================================================================
   ...
   -  ``Session``      
      ...
      /           Session
      =========== =====================================================
      부하(요청)	반응성과 재사용성이 좋은 서버로 로드가 가중됨
      연결비용    낮음 (재사용할 수 있는 세션이 없을 때만 연결)
      재사용성    높음 (항상 연결된 세션을 우선 사용)
      세션수	    적음 (동시에 진행되는 HTTP 트랜잭션 만큼 세션 존재)
      =========== =====================================================
