...
서비스 형식에 따라 메모리에 적재되는 데이터 비율을 조절하면 효과적이다. ::
...
============= ============== =============== ============= ======
물리 메모리   Free           Contents        파일개수      소켓
============= ============== =============== ============= ======
1GB           409.60MB       188.37MB        219,469       5천    
2GB           819.20MB       446.74MB        520,494       1만
4GB           1.60GB         963.49MB        1,122,544     2만
8GB           3.20GB         2.05GB          2,440,422     2만 
16GB          6.40GB         4.45GB          5,303,733     2만 
32GB          12.80GB        9.25GB          11,030,356    2만 
64GB          25.60GB        18.85GB         22,483,603    2만 
128GB         51.20GB        38.05GB         45,390,095    2만 
============= ============== =============== ============= ======

.. note::

   물리 메모리가 감소할 경우(i.e. 16GB -> 8GB) 오래된 순서대로 파일이 삭제됩니다.   
