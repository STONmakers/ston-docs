...
장비를 선택할 수 있도록 돕는 것 또한 매우 중요하다. 왜냐하면 서비스의 특성과 규모에 
...
-  **메모리**
   ...
   성능이 향상되는데, 물리적인 메모리가 작다면 디스크 부하가 가중된다.
   서비스되는 콘텐츠 개수와 상관없이 크기가 커서 디스크 I/O 부하가 높다면 
